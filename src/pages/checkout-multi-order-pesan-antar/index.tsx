...
const CheckoutMultiPesanAntar: PageComponent = (props: Props) => {
  ...
  useEffect(() => {
    ...
    settotalMenuCost(newTotalMenuCost);
    settotalPembayaran(
      newTotalMenuCost +
        biayaLayanan +
        fasPembayaran +
  ...
  return (
    <Container>
      ...
      <Grid
        container={true}
        spacing={2}
        sx={{ marginBottom: '1rem', backgroundColor: '#D5ECFE' }}
      >
        <Grid
          item={true}
          sx={{
            ...
            {DeliveryType.map((obj) => {
              return (
                <Button
                  ...
                  sx={{
                    alignItems: 'center',
                    backgroundColor: selectedDeliveryTypes.has(obj.text)
                      ? 'rgba(0, 0, 0, 0.1)'
                      : 'transparent',
                    '&:hover': {
                  ...
                  variant={
                    selectedDeliveryTypes.has(obj.text) ? 'contained' : 'text'
                  }
            ...
            {Delivery.map((obj) => {
              return (
                <Button
                  ...
                  sx={{
                    alignItems: 'center',
                    backgroundColor: selectedDelivery.has(obj.text)
                      ? 'rgba(0, 0, 0, 0.1)'
                      : 'transparent',
                    '&:hover': {
                      backgroundColor: 'rgba(0, 0, 0, 0.1)'
                  ...
                  variant={
                    selectedDelivery.has(obj.text) ? 'contained' : 'text'
                  }
      ...
      >
        <Box sx={style}>
          ...
          <Typography
            ...
            variant="body1"
          >
            Yuk, pesan makanan kesukaanmu dengan mudah! Dengan multi order, kamu
            dapat pesan makanan melalui resto yang searah, gak perlu
            muter-muter!
          </Typography>
          <Box
            gap={2}
...
CheckoutMultiPesanAntar.displayName = 'CheckoutMultiPesanAntar';

export default CheckoutMultiPesanAntar;
