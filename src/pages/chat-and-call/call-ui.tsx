    ...
    >
      <Box sx={{ flexGrow: 1, overflow: 'auto', marginTop: '3rem' }}>
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          ...
          >
            <Typography color="black" sx={{ textAlign: 'center' }} variant="h3">
              Resto Sunda Gila
            </Typography>
          </Box>
        </div>
      ...
      >
        ...
        >
          ...
          >
            <VolumeUpIcon style={{ color: theme.palette.primary.main }} />
          </IconButton>
        </Grid>
        <Grid
          item={true}
        ...
        >
          ...
          >
            <MicNoneIcon style={{ color: theme.palette.primary.main }} />
          </IconButton>
        </Grid>
        <Grid
          item={true}
