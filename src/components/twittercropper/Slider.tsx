...
export class Slider extends PureComponent<Props> {
	...
	render() {
		...
		return (
			<div className={cn('twitter-cropper-slider', className)} ref={this.line}>
				<div className="twitter-cropper-slider__line">
					<div
						className="twitter-cropper-slider__fill"
						style={{
							flexGrow: value,
						}}
					/>
					<div
						className={cn(
							'twitter-cropper-slider__circle',
							this.state.focus && 'twitter-cropper-slider__circle--focus',
						)}
						style={{
							left: `${value * 100}%`,
						}}
					>
						<div
							className={cn(
								'twitter-cropper-slider__inner-circle',
								this.state.focus && 'twitter-cropper-slider__inner-circle--focus',
							)}
						/>
					</div>
				</div>
